...
# After introducing Guardrails, the entire structure of the [POST] request changes. 
# We implement the guardrails
@app.post("/query")
def query(request: QueryRequest):
    ...
    # with the Guardrails, everything changes this way
    try:
